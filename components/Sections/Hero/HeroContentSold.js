...
export default function HeroContentSold() {
    ...
    <div className={styles.hero__content}>
      <div className={styles["hero-box"]}>
        <div className={styles["hero-box__flex-end"]}>
          <animated.h2 
            className={classNames(['h2', 'text-uppercase', styles["hero-box__title"], styles["hero-box__title_fluid"]])}
            style={HERO_ANIMATED_VARIATIONS.h2(isLoading)}
          >
            sold
            <span className="text-cherry"> out!</span>
          </animated.h2 >
        </div>
        ...
        <div className={styles["hero-box__flex-end"]}>
          <animated.div 
            className={classNames(styles["hero-box__number-wrap"], styles["hero-box__number-wrap_sold"])}
            style={HERO_ANIMATED_VARIATIONS.numberWrap(isLoading)}
          >
            <span className={styles["hero-box__poly"]}>
              <Polyhedron
                color="#fff"
                size={130}
              >
                  <span className={styles["hero-box__poly-title"]}>5k</span>
                  <span className={styles["hero-box__poly-desc"]}>minted</span>
              </Polyhedron>
            </span>
